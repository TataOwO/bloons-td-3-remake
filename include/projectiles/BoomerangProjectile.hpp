...
private:
	...
	std::vector<glm::vec2> move_direction_reference_vector = {{0, 0}, {8, 12}, {9, 15}, {6, 17}, {5, 18}, {1, 20}, {-6, 19}, {-10, 16}, {-13, 12}, {-17, 7}, {-20, 0}, {-16, -2}, {-17, -5}, {-13, -12}, {-9, -12}, {-3, -15}, {1, -14}, {4, -12}, {6, -13}, {8, -11}, {9, -1}, {11, -22}, {10, -12}, {14, -11}, {16, -6}};
